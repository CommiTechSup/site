        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("min") !== undefined || $this.attr("aria-valuemin") !== undefined) {
              ...
              message = "Trop cours: Minimum de '" + min + "'<!-- data-validation-min-message to override -->";
            ...
            if ($this.attr("minlength") !== undefined) {
              message = "Trop cours: Minimum de '" + $this.attr("minlength") + "' caractères<!-- data-validation-minlength-message to override -->";
